...
# Hyperparameters matched to the dataset routing in train.py
HYPERPARAMS = {
...
# NEW: The K values discovered via the Elbow Method on smoothed features
ELBOW_PREDICTED_K = {
    "facebook_107": 8,
    "facebook_348": 7,
    "facebook_414": 10,
...
def run_fcm_on_facebook_datasets():
    ...
    print(f"Running FCM on {len(datasets)} Facebook datasets using ELBOW PREDICTED K...")
    ...
    for dataset_name in datasets:
        ...
        # NEW: Fetch the Elbow K instead of relying on ground-truth
        cluster_num = ELBOW_PREDICTED_K[dataset_name]
        print(f"  -> Using Elbow K = {cluster_num}")
